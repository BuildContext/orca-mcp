...
export const DOCTRINE = {
  ...
  await_statuses: {
    ...
    empty_stalled:
      ...
      'Do check --peek (or action=check peek), optional worker ping via cli/terminal send, ' +
  ...
  health:
    'Optional diagnostics (compact by default: ok, bridge.version, versionOk, statusProbe.ok, sender, toolsets, next). ' +
